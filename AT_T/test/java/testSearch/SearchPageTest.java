...
public class SearchPageTest extends CommonAPI {
    ...
    public void userCanSearchForItems()  {
        ...
        search.searchForItem("iPhone");
    }
    @Test(priority = 2)
    public void userCanSearchiPad() {
        SearchPage search = PageFactory.initElements(driver,SearchPage.class);
        search.searchForItem("ipad");
    }
    @Test(priority = 3)
    public void userCanSearchHeadPhones() {
        SearchPage search = PageFactory.initElements(driver,SearchPage.class);
        search.searchForItem("headPhones");
    }
    @Test(priority = 4)
    public void userCanSearchWallCharger(){
        SearchPage search = PageFactory.initElements(driver,SearchPage.class);
        search.searchForItem("Wall Charger");
    }
    @Test(priority = 5)
    public void userCanSearchForWirelessCharger(){
        SearchPage search = PageFactory.initElements(driver,SearchPage.class);
        search.searchForItem("Wireless Charger");
    }
    @Test(priority = 6)
    public void userCanSearchForPencil(){
        SearchPage search = PageFactory.initElements(driver,SearchPage.class);
        search.searchForItem("Apple Pencil for iPad");
    }
    @Test(priority = 7)
    public void userCanSearchForKeyBoard(){
        SearchPage search = PageFactory.initElements(driver,SearchPage.class);
        search.searchForItem("Logitech Slim Folio Pro 11 - inch Keyboard - Black");
    }
    @Test(priority = 8)
    public void userCanSearchForKeyBoardToo(){
        SearchPage search = PageFactory.initElements(driver,SearchPage.class);
        search.searchForItem("ALogitech Slim Folio Pro 12.9 - inch Keyboard - Black");
    }
    @Test(priority = 9)
    public void userCanSearchForCase(){
        SearchPage search = PageFactory.initElements(driver,SearchPage.class);
        search.searchForItem("Apple iPhone 11 Pro Max Leather Case - Saddle Brown");
    }
    @Test(priority = 10)
    public void userCanSearchClearCase(){
        SearchPage search = PageFactory.initElements(driver,SearchPage.class);
        search.searchForItem("Apple iPhone 11 Pro Max Clear Case");
    }
    @Test(priority = 11)
